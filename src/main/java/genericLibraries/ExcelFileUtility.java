...
public class ExcelFileUtility {
	...
	public String fetchDataFromExcel ( String SheetName, int rowMum, int cellNum) {
	    return workbook.getSheet(SheetName).getRow(rowMum).getCell(cellNum).getStringCellValue();	
	}
	/**
